...
versions=(
    ...
    "ES_VERSION=9.0.1 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.1"
    "ES_VERSION=9.0.2 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.2"
    "ES_VERSION=9.0.3 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.3"
    "ES_VERSION=9.0.4 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.4"
    "ES_VERSION=9.0.5 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.5"
    "ES_VERSION=9.0.6 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.6"
    "ES_VERSION=9.0.7 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.7"
    "ES_VERSION=9.0.6 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.6"
    "ES_VERSION=9.0.8 SG_VERSION=3.1.3 SG_KIBANA_VERSION=9.0.8"

    "ES_VERSION=9.1.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.7"
    "ES_VERSION=9.1.0 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.0"
    "ES_VERSION=9.1.1 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.1"
    "ES_VERSION=9.1.2 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.2"
    "ES_VERSION=9.1.3 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.3"
    "ES_VERSION=9.1.4 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.4"
    "ES_VERSION=9.1.5 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.5"
    "ES_VERSION=9.1.6 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.6"

    "ES_VERSION=9.0.8 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.8"
    "ES_VERSION=9.0.7 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.7"
    "ES_VERSION=9.0.6 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.6"
    "ES_VERSION=9.0.5 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.5"
    "ES_VERSION=9.0.4 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.4"
    "ES_VERSION=9.0.3 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.3"
    "ES_VERSION=9.0.2 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.2"
    "ES_VERSION=9.0.1 SG_VERSION=3.1.2 SG_KIBANA_VERSION=9.0.1"
