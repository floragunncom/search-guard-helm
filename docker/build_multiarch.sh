...
versions=(
    # version 8
    "ELK_VERSION=4.0.0 SG_VERSION=8.19.6 SG_KIBANA_VERSION=8.19.6"
    "ELK_VERSION=4.0.0 SG_VERSION=8.19.6 SG_KIBANA_VERSION=8.19.7"
    # version 9
    "ELK_VERSION=9.1.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.5"
    "ELK_VERSION=9.1.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.6"
    "ELK_VERSION=9.1.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=9.1.7"
)
