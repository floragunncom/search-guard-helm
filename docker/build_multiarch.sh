...
versions=(
    # # version 8
    "ELK_VERSION=8.19.6 SG_VERSION=4.0.0 SG_KIBANA_VERSION=4.0.0"
    "ELK_VERSION=8.19.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=4.0.0"
    # # version 9
    "ELK_VERSION=9.1.5 SG_VERSION=4.0.0 SG_KIBANA_VERSION=4.0.0"
    "ELK_VERSION=9.1.6 SG_VERSION=4.0.0 SG_KIBANA_VERSION=4.0.0"
    "ELK_VERSION=9.1.7 SG_VERSION=4.0.0 SG_KIBANA_VERSION=4.0.0"
)
...
sgctl_versions=(
    ...
    "SGCTL_VERSION=4.0.0 JAVA_VERSION=17-jre"
)
...
do
    ...
    build elasticsearch "$SG_VERSION-es-$ELK_VERSION"  --build-arg ELK_VERSION="$ELK_VERSION"   --build-arg SG_VERSION="$SG_VERSION"
