...
versions=(
    ...
    "SG_FLAVOUR=non-flx ELK_VERSION=7.10.2 SG_VERSION=53.6.0 SG_KIBANA_VERSION=53.0.0 KIBANA_PLATFORMS=linux/amd64 JAVA_BASE_IMAGE=adoptopenjdk:15-jre-hotspot-focal"
    "SG_FLAVOUR=non-flx ELK_VERSION=7.10.2 SG_VERSION=53.6.0 SG_KIBANA_VERSION=53.0.0 KIBANA_PLATFORMS=linux/amd64 JAVA_BASE_IMAGE=adoptopenjdk:15-jre-hotspot-focal ELK_FLAVOUR=-oss"
    
    "SG_FLAVOUR=non-flx ELK_VERSION=7.17.7 SG_VERSION=53.6.0 SG_KIBANA_VERSION=53.0.0 JAVA_VERSION=19-jre"
    "SG_FLAVOUR=non-flx ELK_VERSION=7.17.8 SG_VERSION=53.6.0 SG_KIBANA_VERSION=53.0.0 JAVA_VERSION=19-jre"
    #"SG_FLAVOUR=non-flx ELK_VERSION=7.17.3 SG_VERSION=53.4.0 SG_KIBANA_VERSION=53.0.0 JAVA_VERSION=18-jre"
    #"SG_FLAVOUR=non-flx ELK_VERSION=7.17.4 SG_VERSION=53.4.0 SG_KIBANA_VERSION=53.0.0 JAVA_VERSION=18-jre"
    #"SG_FLAVOUR=non-flx ELK_VERSION=7.16.3 SG_VERSION=53.4.0 SG_KIBANA_VERSION=53.0.0 JAVA_VERSION=17-jre"
    #"SG_FLAVOUR=non-flx ELK_VERSION=7.15.2 SG_VERSION=52.5.0 SG_KIBANA_VERSION=52.1.0 JAVA_VERSION=16-jdk"
    ...
    #"SG_FLAVOUR=flx ELK_VERSION=7.17.3 SG_VERSION=1.0.0-beta-2 SG_KIBANA_VERSION=1.0.0-beta-2"
    #"SG_FLAVOUR=flx ELK_VERSION=7.16.3 SG_VERSION=1.0.0-beta-2 SG_KIBANA_VERSION=1.0.0-beta-2"
    ...
    #"SG_FLAVOUR=flx ELK_VERSION=8.2.3 SG_VERSION=1.0.0-beta-1 SG_KIBANA_VERSION="
    "SG_FLAVOUR=flx ELK_VERSION=8.5.3 SG_VERSION=1.1.0 SG_KIBANA_VERSION=1.1.0"
...
do
    ...
    if [ "$SG_FLAVOUR" = "non-flx" ] && [ "$(echo $ELK_VERSION | cut -d. -f1-1)" = "7" ];then
        if [ -z "$JAVA_BASE_IMAGE" ]; then
            build sgadmin "$ELK_VERSION-$SG_VERSION" --build-arg ELK_VERSION="$ELK_VERSION" --build-arg SG_VERSION="$SG_VERSION" --build-arg JAVA_VERSION="$JAVA_VERSION"
        else
            build sgadmin "$ELK_VERSION-$SG_VERSION" --build-arg ELK_VERSION="$ELK_VERSION" --build-arg SG_VERSION="$SG_VERSION" --build-arg JAVA_VERSION="$JAVA_VERSION" --build-arg JAVA_BASE_IMAGE="$JAVA_BASE_IMAGE"
        fi
